...
export interface ApiClientClient extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Primary_font: Attribute.String;
    Primary_Colour: Attribute.Text;
    Secondary_Colour: Attribute.String;
    Button_Colour: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiDisplayDeviceDisplayDevice extends Schema.SingleType {
  ...
  attributes: {
    ...
    Retail_Price: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    Google_URL: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    Continue_text: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    No_Search: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
